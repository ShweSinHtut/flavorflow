...
<body>
  <div class="container">
      ...
      <div class="render">
        ...
        <div class="details">
          <div>
            <div><?php echo $product['price']; ?> MMK</div>
            <div class="line"></div>
            <div class="ingredients"><?php echo $product['ingredients']; ?></div>
            <div class="line"></div>
      ...
      <dialog class="modal">
        <form action="products-details.php" method="post" enctype="multipart/form-data">
          <h2><?php echo $product['name']; ?></h2>
          <input type="hidden" name="food-name" value="<?php echo $product['name']; ?>">
